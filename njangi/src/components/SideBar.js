  ...
  return (
    <div className="sidebar flex-col-hstart-vstart">
        <div className="menus flex-col-hstart-vstart">
          <button className="groups flex-row active-menu">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/unify-bc2ad.appspot.com/o/4qtl03lzyc5-I156%3A2289%3B156%3A2257?alt=media&token=362908cc-07ae-484c-8284-38e540ee52c6"
              alt="Not Found"
              className="icon"
            />
            <p>Groups</p>
          </button>
          <div className="chats flex-row-vcenter">
            <img
          ...
          <div className="schedules flex-row-vcenter">
            <img
          ...
          <div className="transactions flex-row-vcenter">
            <img
